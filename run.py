...
# Logging
if dev_mode:
    logging.basicConfig(filename='./my_data/run.log', encoding='utf-8', level=logging.DEBUG, filemode='w', format="%(asctime)s %(levelname)s %(message)s")
else:
    logging.basicConfig(filename='./my_data/run.log', encoding='utf-8', level=logging.INFO, filemode='w', format="%(asctime)s %(levelname)s %(message)s")
...
logging.info('Balance factor: 0.7') # TODO: make balance_factor variable
